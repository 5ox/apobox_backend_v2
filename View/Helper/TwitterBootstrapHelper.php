...
class TwitterBootstrapHelper extends HtmlHelper {
	 ...
	 *
	 * @param mixed $title Link title
	 * @param mixed $url The url
	 * @param array $opt Optional options
	 * @param bool $confirm Add Js confirmation
	 * @return string
	 * @access public
	 */
	...
	protected function _setGetCrumbsOptions($options) {
		$classes = (isset($options['class'])) ? explode(' ', (string)$options['class']) : [];
		$classes[] = 'breadcrumb';
