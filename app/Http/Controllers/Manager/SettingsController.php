...
class SettingsController extends Controller
{
    ...
    protected function getSampleData(string $key): array
    {
        $common = [
            ...
            'orderId' => '12345',
            'url' => 'https://app.apobox.com/example-link',
            'payUrl' => 'https://app.apobox.com/pay/12345',
            ...
            'almostFinishedUrl' => 'https://app.apobox.com/complete-signup',
            'addAddressUrl' => 'https://app.apobox.com/add-address',
            'updatePaymentUrl' => 'https://app.apobox.com/update-payment',
            'name' => 'John Doe',
