...
CakePlugin::loadAll(array(
	...
	'SerializersErrors' => array('bootstrap' => true),
));

// The above loadAll does not load these for mysterious reasons:
CakePlugin::load('Usps');
CakePlugin::load('Fedex');
...
CakeLog::config('email', [
	'engine' => 'File',
	'types' => ['email-warning', 'email-error'],
	'file' => 'email',
	'mask' => 0664,
	'size' => false,
]);
CakeLog::config('login', [
	'engine' => 'File',
	'types' => ['login-error'],
	'file' => 'login',
	'mask' => 0664,
