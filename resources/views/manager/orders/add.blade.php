...
<x-page-header title="New Order" subtitle="{{ $customer->full_name }}" />
...
<form method="POST" action="/{{ $prefix }}/orders/add/{{ $customer->customers_id }}">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <x-form-section title="Dimensions & Weight">
            ...
            <x-form-section title="Shipping Details">
                <div class="mb-3">
    ...
    @if($requests->isNotEmpty())
        <x-form-section title="Link Custom Request">
            <div class="mb-3">
