...
@section('title', 'Add Insurance Tier - APO Box Admin')
@section('content')
@php $prefix = auth('admin')->user()->routePrefix(); @endphp

<x-page-header title="Add Insurance Tier" />

<x-form-section title="New Insurance Tier">
    <form method="POST" action="/{{ $prefix }}/settings/insurance-tiers/add">
        @csrf
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <input type="number" name="amount_from" class="form-control @error('amount_from') is-invalid @enderror"
                       value="{{ old('amount_from') }}" step="0.01" min="0" required>
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="amount_to" class="form-control @error('amount_to') is-invalid @enderror"
                       value="{{ old('amount_to') }}" step="0.01" min="0" required>
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="insurance_fee" class="form-control @error('insurance_fee') is-invalid @enderror"
                       value="{{ old('insurance_fee') }}" step="0.01" min="0" required>
